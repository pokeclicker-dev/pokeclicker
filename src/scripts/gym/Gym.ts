...
gymList['Elite Flint'] = new Gym(
    ...
    'Elite Flint',
    [
        new GymPokemon('Houndoom', 3145330, 52),
        new GymPokemon('Flareon', 3148300, 55),
        new GymPokemon('Rapidash', 3152000, 53),
        new GymPokemon('Infernape', 3157000, 55),
        new GymPokemon('Magmortar', 3160250, 57),
    ],
...
gymList['Elite Lucian'] = new Gym(
    ...
    'Elite Lucian',
    [
        new GymPokemon('Mr. Mime', 3248300, 53),
        new GymPokemon('Espeon', 3252000, 55),
        new GymPokemon('Bronzong', 3257000, 54),
        new GymPokemon('Alakazam', 3260250, 56),
        new GymPokemon('Gallade', 3266000, 59),
    ],
...
gymList['Champion Cynthia'] = new Gym(
    ...
    [
        ...
        new GymPokemon('Togekiss', 3464000, 58),
