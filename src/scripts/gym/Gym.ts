...
gymList['Oreburgh City'] = new Gym(
    ...
    'Oreburgh City',
    [
        new GymPokemon('Geodude', 1938000, 12),
        new GymPokemon('Onix', 1942000, 12),
        new GymPokemon('Cranidos', 1942000, 14),
    ],
...
gymList['Eterna City'] = new Gym(
    ...
    'Eterna City',
    [
        new GymPokemon('Turtwig', 2033000, 20),
        new GymPokemon('Cherrim (overcast)', 2037500, 20),
        new GymPokemon('Roserade', 2039000, 22),
    ],
...
gymList['Hearthome City'] = new Gym(
    ...
    'Hearthome City',
    [
        new GymPokemon('Duskull', 2050000, 24),
        new GymPokemon('Haunter', 2080000, 24),
        new GymPokemon('Mismagius', 2080000, 26),
    ],
...
gymList['Veilstone City'] = new Gym(
    ...
    'Veilstone City',
    [
        new GymPokemon('Meditite', 2137000, 28),
        new GymPokemon('Machoke', 2138000, 29),
        new GymPokemon('Lucario', 2140000, 32),
    ],
...
gymList['Pastoria City'] = new Gym(
    ...
    'Pastoria City',
    [
        new GymPokemon('Gyarados', 2187000, 33),
        new GymPokemon('Quagsire', 2193000, 34),
        new GymPokemon('Floatzel', 2193000, 37),
    ],
    BadgeCase.Badge.Fen,
    40000,
...
gymList['Canalave City'] = new Gym(
    ...
    'Canalave City',
    [
        new GymPokemon('Magneton', 2267000, 37),
        new GymPokemon('Steelix', 2272000, 38),
        new GymPokemon('Magnemite', 2268000, 41),
    ],
...
gymList['Snowpoint City'] = new Gym(
    ...
    'Snowpoint City',
    [
        new GymPokemon('Sneasel', 2372500, 40),
        new GymPokemon('Piloswine', 2376000, 40),
        new GymPokemon('Abomasnow', 2370000, 42),
        new GymPokemon('Froslass', 2370000, 44),
    ],
...
gymList['Sunyshore City'] = new Gym(
    ...
    'Sunyshore City',
    [
        new GymPokemon('Jolteon', 2465000, 46),
        new GymPokemon('Raichu', 2465000, 46),
        new GymPokemon('Luxray', 2478000, 48),
        new GymPokemon('Electivire', 2480000, 50),
    ],
...
gymList['Elite Aaron'] = new Gym(
    ...
    'Elite Aaron',
    [
        new GymPokemon('Yanmega', 2945330, 49),
        new GymPokemon('Scizor', 2948300, 49),
        new GymPokemon('Vespiquen', 2952000, 50),
        new GymPokemon('Heracross', 2957000, 51),
        new GymPokemon('Drapion', 2960250, 53),
    ],
...
gymList['Elite Bertha'] = new Gym(
    ...
    'Elite Bertha',
    [
        new GymPokemon('Whiscash', 3045330, 50),
        new GymPokemon('Gliscor', 3048300, 53),
        new GymPokemon('Golem', 3052000, 52),
        new GymPokemon('Rhyperior', 3057000, 52),
        new GymPokemon('Hippowdon', 3060250, 55),
    ],
...
gymList['Elite Flint'] = new Gym(
    ...
    'Elite Flint',
    [
        new GymPokemon('Houndoom', 3045330, 52),
        new GymPokemon('Flareon', 3048300, 55),
        new GymPokemon('Rapidash', 3052000, 53),
        new GymPokemon('Infernape', 3057000, 55),
        new GymPokemon('Magmortar', 3060250, 57),
    ],
...
gymList['Champion Cynthia'] = new Gym(
    ...
    'Champion Cynthia',
    [
        new GymPokemon('Spiritomb', 3058300, 58),
        new GymPokemon('Roserade', 3062000, 58),
        new GymPokemon('Togekiss', 3064000, 58),
        new GymPokemon('Lucario', 3060250, 60),
        new GymPokemon('Milotic', 3070000, 58),
        new GymPokemon('Garchomp', 3070000, 62),
    ],
