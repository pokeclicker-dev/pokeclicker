...
class Dungeon {
    ...
    public isUnlocked(): boolean {
        ...
        // TODO: All this can probably be removed as it's already in the "DungeonTown" class
        const unlocked = this.requirements.every(requirement => requirement.isCompleted());
...
dungeonList['Viridian Forest'] = new Dungeon('Viridian Forest',
    ...
    50, [new GymBadgeRequirement(BadgeCase.Badge.None)], 1, 5
);
...
dungeonList['Digletts Cave'] = new Dungeon('Digletts Cave',
    ...
    95, [new GymBadgeRequirement(BadgeCase.Badge.Boulder)], 2, 22
);
...
dungeonList['Mt. Moon'] = new Dungeon('Mt. Moon',
    ...
    75, [new GymBadgeRequirement(BadgeCase.Badge.Boulder)], 4, 10
);
...
dungeonList['Rock Tunnel'] = new Dungeon('Rock Tunnel',
    ...
    500, [new GymBadgeRequirement(BadgeCase.Badge.Cascade)], 5, 15
);
...
dungeonList['Power Plant'] = new Dungeon('Power Plant',
    ...
    1000, [new GymBadgeRequirement(BadgeCase.Badge.Cascade)], 8, 25
);
...
dungeonList['Pokemon Tower'] = new Dungeon('Pokemon Tower',
    ...
    750, [new GymBadgeRequirement(BadgeCase.Badge.Cascade)], 10, 20
);
...
dungeonList['Seafoam Islands'] = new Dungeon('Seafoam Islands',
    ...
    1250, [new GymBadgeRequirement(BadgeCase.Badge.Soul)], 15, 30
);
...
dungeonList['Pokemon Mansion'] = new Dungeon('Pokemon Mansion',
    ...
    1500, [new GymBadgeRequirement(BadgeCase.Badge.Soul)], 16, 35
);
...
dungeonList['Victory Road'] = new Dungeon('Victory Road',
    ...
    2000, [new GymBadgeRequirement(BadgeCase.Badge.Earth)], 20, 40
);
...
dungeonList['Cerulean Cave'] = new Dungeon('Cerulean Cave',
    ...
    2500, [new GymBadgeRequirement(BadgeCase.Badge.Elite_KantoChampion)], 20, 55
);
...
dungeonList['Sprout Tower'] = new Dungeon('Sprout Tower',
    ...
    2500, [new GymBadgeRequirement(BadgeCase.Badge.Elite_KantoChampion)], 31, 5
);
...
dungeonList['Ruins of Alph'] = new Dungeon('Ruins of Alph',
    ...
    3000, [new GymBadgeRequirement(BadgeCase.Badge.Zephyr)], 32, 7
);
...
dungeonList['Slowpoke Well'] = new Dungeon('Slowpoke Well',
    ...
    3500, [new GymBadgeRequirement(BadgeCase.Badge.Zephyr)], 33, 12
);
...
dungeonList['Ilex Forest'] = new Dungeon('Ilex Forest',
    ...
    4000, [new GymBadgeRequirement(BadgeCase.Badge.Hive)], 34, 15
);
...
dungeonList['Burned Tower'] = new Dungeon('Burned Tower',
    ...
    4500, [new GymBadgeRequirement(BadgeCase.Badge.Fog)], 37, 20
);
...
dungeonList['Whirl Islands'] = new Dungeon('Whirl Islands',
    ...
    5000, [new GymBadgeRequirement(BadgeCase.Badge.Storm)], 41, 25
);
...
dungeonList['Mt Mortar'] = new Dungeon('Mt Mortar',
    ...
    5500, [new GymBadgeRequirement(BadgeCase.Badge.Storm)], 42, 30
);
...
dungeonList['Ice Path'] = new Dungeon('Ice Path',
    ...
    6000, [new GymBadgeRequirement(BadgeCase.Badge.Glacier)], 44, 32
);
...
dungeonList['Dark Cave'] = new Dungeon('Dark Cave',
    ...
    6500, [new GymBadgeRequirement(BadgeCase.Badge.Rising)], 45, 35
);
...
dungeonList['Mt Silver'] = new Dungeon('Mt Silver',
    ...
    10000, [new GymBadgeRequirement(BadgeCase.Badge.Elite_Karen)], 28, 50
);
...
dungeonList['Rusturf Tunnel'] = new Dungeon('Rusturf Tunnel',
    ...
    14000, [new GymBadgeRequirement(BadgeCase.Badge.Stone)], 101, 5);
...
dungeonList['Granite Cave'] = new Dungeon('Granite Cave',
    ...
    16000, [new GymBadgeRequirement(BadgeCase.Badge.Stone)], 101, 5);
...
dungeonList['Fiery Path'] = new Dungeon('Fiery Path',
    ...
    17000, [new GymBadgeRequirement(BadgeCase.Badge.Stone)], 101, 5);
...
dungeonList['Meteor Falls'] = new Dungeon('Meteor Falls',
    ...
    18000, [new GymBadgeRequirement(BadgeCase.Badge.Stone)], 101, 5);
...
dungeonList['Mt. Chimney'] = new Dungeon('Mt. Chimney',
    ...
    20000, [new GymBadgeRequirement(BadgeCase.Badge.Stone)], 101, 5);
...
dungeonList['Jagged Pass'] = new Dungeon('Jagged Pass',
    ...
    22000, [new GymBadgeRequirement(BadgeCase.Badge.Stone)], 101, 5);
...
dungeonList['New Mauville'] = new Dungeon('New Mauville',
    ...
    24000, [new GymBadgeRequirement(BadgeCase.Badge.Stone)], 101, 5);
...
dungeonList['Mt. Pyre'] = new Dungeon('Mt. Pyre',
    ...
    26000, [new GymBadgeRequirement(BadgeCase.Badge.Stone)], 101, 5);
...
dungeonList['Shoal Cave'] = new Dungeon('Shoal Cave',
    ...
    12000, [new GymBadgeRequirement(BadgeCase.Badge.Stone)], 101, 5);
...
dungeonList['Cave of Origin'] = new Dungeon('Cave of Origin',
    ...
    34000, [new GymBadgeRequirement(BadgeCase.Badge.Stone)], 101, 5);
...
dungeonList['Seafloor Cavern'] = new Dungeon('Seafloor Cavern',
    ...
    31000, [new GymBadgeRequirement(BadgeCase.Badge.Stone)], 101, 5);
...
dungeonList['Sky Pillar'] = new Dungeon('Sky Pillar',
    ...
    40000, [new GymBadgeRequirement(BadgeCase.Badge.Stone)], 101, 5);
...
dungeonList['Victory Road Hoenn'] = new Dungeon('Victory Road Hoenn',
    ...
    37000, [new GymBadgeRequirement(BadgeCase.Badge.Stone)], 101, 5);
